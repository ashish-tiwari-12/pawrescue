...
export const LandingPage: React.FC<Props> = ({
  ...
  return (
    <div className="min-h-screen bg-[#faf8ff]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-100/80 border border-orange-200 text-orange-900 text-xs font-semibold">
                ...
                <span>Stray Animal Rescue & NGO Network</span>
              </div>
              ...
              <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
                Spotted an injured, sick, or distressed stray animal? Share photos and location. Verified NGOs and rescue teams respond immediately.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-[#f97316] hover:bg-orange-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2.5 transition-all hover:scale-105 active:scale-95 group animate-urgent-pulse cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-7 py-4 bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 rounded-xl text-sm font-bold shadow-sm flex items-center justify-center gap-2 transition-all hover:border-slate-300 cursor-pointer"
                >
                  ...
                  <div className="space-y-4">
                    <div className="relative rounded-2xl overflow-hidden aspect-video bg-slate-900 shadow-md">
                      ...
                      <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-3 text-white text-xs">
                        ...
                        <p className="text-[11px] text-slate-200">SV Road, Andheri West</p>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <span>Report a Dog</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="p-5 rounded-2xl bg-orange-50/50 border border-orange-100 text-center">
              ...
              <p className="text-xs font-semibold text-slate-700 mt-1">Animals Rescued</p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-indigo-50/50 border border-indigo-100 text-center">
              ...
              <p className="text-xs font-semibold text-slate-700 mt-1">Verified NGOs</p>
            </div>
            <div className="p-5 rounded-2xl bg-purple-50/50 border border-purple-100 text-center">
              ...
              <p className="text-xs font-semibold text-slate-700 mt-1">Active Citizens</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#faf8ff] border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Fast, Coordinated Rescue
            </h2>
            <p className="text-slate-600 text-xs sm:text-sm">
              Connecting citizen reports with rescue teams in four simple steps.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card-elevation-1 rounded-2xl p-6 relative hover:shadow-md transition-shadow group bg-white">
              <div className="w-11 h-11 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center font-bold text-lg mb-3 group-hover:scale-105 transition-transform">
                <span className="material-symbols-outlined">add_a_photo</span>
              </div>
              <span className="text-[11px] font-bold text-orange-600">STEP 01</span>
              <h3 className="font-bold text-slate-900 text-sm mt-0.5 mb-1.5">
                Snap & Spot
              </h3>
              <p className="text-slate-600 text-xs leading-relaxed">
                Take a photo. GPS auto-detects your location and landmark.
              </p>
            </div>

            <div className="card-elevation-1 rounded-2xl p-6 relative hover:shadow-md transition-shadow group bg-white">
              <div className="w-11 h-11 rounded-2xl bg-purple-100 text-purple-600 flex items-center justify-center font-bold text-lg mb-3 group-hover:scale-105 transition-transform">
                <span className="material-symbols-outlined">hub</span>
              </div>
              <span className="text-[11px] font-bold text-purple-600">STEP 02</span>
              <h3 className="font-bold text-slate-900 text-sm mt-0.5 mb-1.5">
                Instant Triage
              </h3>
              <p className="text-slate-600 text-xs leading-relaxed">
                Smart routing alerts verified NGOs in the coverage area.
              </p>
            </div>
            ...
            <div className="card-elevation-1 rounded-2xl p-6 relative hover:shadow-md transition-shadow group bg-white">
              ...
              <span className="text-[11px] font-bold text-orange-600">STEP 03</span>
              <h3 className="font-bold text-slate-900 text-sm mt-0.5 mb-1.5">
                Dispatch Team
              </h3>
              <p className="text-slate-600 text-xs leading-relaxed">
                Rescue handlers and ambulances receive live coordinates.
              </p>
            </div>

            <div className="card-elevation-1 rounded-2xl p-6 relative hover:shadow-md transition-shadow group bg-white">
              <div className="w-11 h-11 rounded-2xl bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-lg mb-3 group-hover:scale-105 transition-transform">
                <span className="material-symbols-outlined">task_alt</span>
              </div>
              <span className="text-[11px] font-bold text-emerald-700">STEP 04</span>
              <h3 className="font-bold text-slate-900 text-sm mt-0.5 mb-1.5">
                Treatment & Care
              </h3>
              <p className="text-slate-600 text-xs leading-relaxed">
                Veterinary care and recovery updates tracked in real time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              ...
              <p className="text-slate-600 text-xs mt-1">
                Active rescue shelters and partners in your area.
              </p>
            </div>
            <button
              onClick={onViewAllReports}
              className="text-xs font-bold text-orange-600 hover:text-orange-700 flex items-center gap-1 self-start md:self-auto cursor-pointer"
            >
              <span>View Reports ({recentComplaints.length})</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {ngos.map((ngo) => (
              <div
                key={ngo.id}
                className="card-elevation-1 rounded-2xl p-5 border border-slate-100 hover:border-orange-200 transition-all group bg-white"
              >
                <div className="flex items-center gap-3.5 mb-3">
                  <img
                    src={ngo.avatarUrl || "https://images.unsplash.com/photo-1548767797-d8c844163c4c?w=150"}
                    alt={ngo.name}
                    className="w-12 h-12 rounded-xl object-cover border border-slate-100 group-hover:scale-105 transition-transform shrink-0"
                  />
                  <div className="min-w-0">
                    <div className="flex items-center gap-1">
                      ...
                      {ngo.verified && (
                        <span
                          className="material-symbols-outlined !text-sm text-emerald-600 shrink-0"
                          title="Verified NGO"
                        >
                          verified
                        </span>
                ...
                <div className="grid grid-cols-2 gap-2.5 py-2.5 border-y border-slate-100 my-2.5 text-center">
                  <div className="bg-slate-50 p-2 rounded-lg">
                    <span className="text-[11px] text-slate-500">Rescues</span>
                    <p className="font-bold text-slate-900 text-xs">{ngo.totalRescued}+</p>
                  </div>
                  <div className="bg-slate-50 p-2 rounded-lg">
                    <span className="text-[11px] text-slate-500">Volunteers</span>
                    <p className="font-bold text-slate-900 text-xs">{ngo.activeVolunteersCount}</p>
                  </div>
                </div>

                <div className="text-[11px] text-slate-500 space-y-0.5">
                  <p className="truncate">
                    <strong>Coverage:</strong> {ngo.pincodesCovered.join(", ")}
                  </p>
                  <p className="truncate">
      ...
      <section className="py-14 bg-gradient-to-r from-[#9d4300] via-[#f97316] to-[#006c49] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-8 text-center space-y-4">
          ...
          <p className="text-white/90 text-xs sm:text-sm max-w-xl mx-auto leading-relaxed">
            Take a quick photo and report. Local rescue teams and ambulances respond immediately.
          </p>
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            <button
              onClick={() => onStartReport(true)}
              className="px-8 py-3 bg-white text-orange-600 hover:bg-orange-50 rounded-xl text-xs font-bold shadow-xl transition-all hover:scale-105 active:scale-95 flex items-center gap-2 cursor-pointer"
            >
