              ...
              <div className="p-4 border-b border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] bg-emerald-100 text-emerald-800 font-bold ml-1 px-1 rounded">
                      NGO
                    </span>
                  </div>
                </div>
              ...
              <div className="p-4 border-t border-slate-100 bg-slate-50">
                {user ? (
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-[#006c49] hover:bg-emerald-800 text-white font-bold text-xs rounded-xl shadow-md flex items-center justify-center gap-1.5 transition-all"
                  >
                    <span className="material-symbols-outlined !text-base">login</span>
                    <span>Sign In to NGO Portal</span>
                  </button>
                )}
              </div>
            </div>
